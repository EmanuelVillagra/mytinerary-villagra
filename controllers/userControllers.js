...
const sendEmail = async (email, uniqueString) => {
  const transporter = nodemailer.createTransport({
    ...
    secure: true,
    auth: {
      user: "usermindhubmailtemp1@gmail.com",
      pass: "mindhubvillagra",
    },
  });

  let sender = "usermindhubmailtemp1@gmail.com";
  let mailOptions = {
    from: sender,
    to: email,
...
const usersControllers = {
  ...
  signUpUsers: async (req, res) => {
    ...
    let { name, lastName, email, password, from, country, userPic } = req.body.userData;
